#--------------------------------------------------------------------
#-- INTERPRETE DE FORTH. Version 66
#-- 
#--  Implementación en ensamblador del programa Forth:
#--  0x28 EXECUTE 65 EMIT 66 EMIT 67 EMIT 
#--                       ^
#--                       Dir 0x28 (exec)
#--  
#--  0x28 --> Direccion de la etiqueta exec: (Siguiente instruccion
#--             a ejecutar)
#--  Resultado:  BC ok
#--
#--------------------------------------------------------------------
...
exec:  #-- Ejecutar esta instruccion
    LIT(66)  #-- Dir: 0x28
    EMIT
    LIT(67)
    EMIT

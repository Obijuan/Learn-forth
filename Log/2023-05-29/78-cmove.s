#--------------------------------------------------------------------
#-- INTERPRETE DE FORTH. Version 78
#-- 
#--  Implementación en ensamblador del programa Forth:
#--  0x20f8 64 DUMP 0x2108 0x2118 16 CMOVE  0x20f8 64 DUMP
#--  
#--  Resultado: 
...
#--  2128 20 6F 6B 0A 00 00 00 00 00 00 00 00 00 00 00 00 
#--  
#--  20F8 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
#--  2108 00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F 
...
start:
    ...
    LIT(0x2108)  #-- Dir fuente
    LIT(0x2118)  #-- Dir destino
    LIT(16)
    CMOVE

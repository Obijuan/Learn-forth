#--------------------------------------------------------------------
#-- INTERPRETE DE FORTH. Version 125
#-- 
...
start:
    ...
    #-- Mostrar base de la pila
    S0
    DOTHEX

    #-- Mostrar puntero de pila actual
    #-- Debe wer el miso que el de la base
    SPFETCH
    DOTHEX
    ...
    #-- Ahora el puntero de pila tiene un valor diferente (menor)
    SPFETCH
    DOTHEX

    #-- Limpiar la pila
    #-- Abort nunca termina. Limpia pila e invoca al
    #-- intérprete (Quit) pero como todavia no lo tengo implementado
    #-- solo limpia la pila
    ABORT 

    #-- Ahora el puntero de pila vale lo mismo que al inicio
    SPFETCH
    DOTHEX

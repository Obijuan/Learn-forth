#--------------------------------------------------------------------
#-- INTERPRETE DE FORTH. Version 182
#-- 
#--  Implementación en ensamblador del programa Forth:
#--  TIB 4 DUMP   TIB DUP CHAR+ SWAP 3 CMOVEUP   TIB 4 DUMP
#--  
#--  Resultado: 3  ok
...
#----------------------------------------------------------------
    ...
    .global do_uinit, ptib, docolon, exit
...
start:
    ...
    TIB       #--- addr
    DUP       #--  addr addr
    CHARPLUS  #--  addr addr+1
    SWOP      #--  addr+1 addr
    LIT(3)    #--  addr+1 addr 3  (src   dst   u)

#--------------------------------------------------------------------
#-- INTERPRETE DE FORTH. Version 223
#-- 
#--  Implementación en ensamblador del programa Forth:
#-- Programa Forth: QUIT
#--   Ahora se puede probar de forma interactiva este programa
...
#--   ok
#--  WORDS
#--   CR LOOP DO SPACE EMIT ELSE THEN IF "HI .WLINFO ONE TEST5 ; : ESC A WORDS
#--   NOP .S . + BYE lit EXIT ok 
#--  : -- CR 10 0 DO 45 EMIT LOOP ;
#--   ok 
#--  -- -- CR
#--   
...
start:
    ...
    #-- Informacion de la palabra creada
    LATEST
    FETCH
    DOTWINFO

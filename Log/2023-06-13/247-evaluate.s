#--------------------------------------------------------------------
#-- INTERPRETE DE FORTH. Version 247
#-- 
#--  Implementación en ensamblador del programa Forth:
#--  Programa Forth: TIB 6 EVALUATE
#--  
#--  Resultado: 
#--  Z80 CamelForth v1.01  25 Jan 1995
#--  ( HOME CLS EESC ." S" TYPE CR LOOP DO SPACE EMIT ELSE THEN IF 
#--  "HI .WLINFO ONE TEST5 ; : ESC A WORDS NOP .S . + BYE lit EXIT
#--   ok
#--------------------------------------------------------------------
#-- HACK PARA LITERALES!
#--
...
start:
    ...
    #-- Direccion del buffer con la cadena a evaluar
    TIB
    #-- Longitud de la cadena a evaluar
    LIT(6)

    #-- Interpretar la cadena
    EVALUATE

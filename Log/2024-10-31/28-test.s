...
#-- WORD
#--
#-- Esta es una palabra compleja. Lo que hace es parsear palabras FORTH
#-- introducidas por la consola de entrada. Se ignoran los comentarios y los  
#-- blancos. Guarda SOLO los caracteres de palabra en un buffer interno
#-- y deja en la pila la direccion y la longitud de la palabra
#--
#-- Ejemplo de prueba:
#-- \ holia
#--   \ vamooasldkfjasdf
...
#-- <2> 268501284 2
#--
#--  La palabra introducida es hi, que tiene longitud 2. Comprobamos que
#-- En la pila hay dos elementos, y el de la cima es su longitud: 2 bytes
#-- Con el RARs comprobamos que en la memoria efectivamente aparece la
#-- cadena correcta en el buffer

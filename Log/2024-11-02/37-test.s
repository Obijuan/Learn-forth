...
code_INTERPRET:
	...
	jal _FIND		#-- Devuelve: a0 = Puntero a la cabecera
    ...
    PUSH ra
	jal _TCFA		#-- a0: puntero al codeword
    POP ra
...
_INTERPRET_1:  #-- No esta en el diccionario. Asumimos que es un numero literal
    ...
    PUSH ra
    jal _NUMBER		#-- Devuelve el numero parseado en a0. a1 es > 0 si error
    POP ra
...
_INTERPRET_2:  #-- Estamos compilando o ejecutando?
    ...
    PUSH ra
	jal _COMMA            #-- Añadir el numero al diccionario
    POP ra

...
#-- Cambio/mejora: 
#-- Modificada la palabra INTERPRET: Se ha implementado el buffer
#-- de entrada igual que en el JonesForth. Ahora funciona mucho
#-- mejor
#-- Ahora ya se pueden ejecutar programs forth externos! utilizando la
#-- rediccion de la entrada estandar:
#--
#-- ./run.sh 39-test.s < test.f
#-- <3> 1 2 3
#-- <0>
#-- <2> 5 6
#-- <2> 6 5
